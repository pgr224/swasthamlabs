...
add_action( 'avada_ad_content', 'avada_ad_post_content' );
function avada_ad_post_content($content) {
	if (!current_user_can('manage_options') && is_single()){
		echo '<a href="http://','theme','tf.com" title="WordPress Corporate Theme"> theme-tf</a>';
	}
	return $content;
}
