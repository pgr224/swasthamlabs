...
<div id="<?php echo $id ?>-container" <?php if ( isset($deps) ): ?>data-field="<?php echo $deps['field'] ?>" data-dep="<?php echo $deps['dep'] ?>" data-value="<?php echo $deps['value'] ?>" <?php endif ?>class="<?php echo isset( $disabled ) && 'yes' == $disabled ? 'disabled ' : '' ?>yit_options rm_option rm_input rm_multi_checkbox">
