...
$footer_extra_row = yit_get_option( 'footer-add-extra-row');
if(  $footer_extra_row == 'yes' ): ?>
    <div class="footer-extra-row clearfix">
        <?php echo do_shortcode( yit_get_option( 'footer-extra-row-content') ) ?>
    </div>
<?php
endif;
