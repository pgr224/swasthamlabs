    ...
    class last_tweets extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            if ( isset( $instance['follow'] ) && $instance['follow'] == 'true' ) {
                ...
                if( is_rtl() ){
                    $fowllow_message = "&larr;" . __('Follow us on Twitter', 'yit');
                }
                echo '<p id="follow-twitter"><a href="https://twitter.com/intent/user?screen_name=' . $username . '" target="_blank">' . apply_filters( 'yit_follow_us_twitter_widget', $fowllow_message ) . '</a>';
            }
