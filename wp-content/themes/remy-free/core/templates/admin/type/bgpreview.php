...
<div id="<?php echo $id ?>-container" <?php if ( isset($deps) ): ?>data-field="<?php echo $id ?>" data-dep="<?php echo $deps['ids'] ?>" data-value="<?php echo $deps['values'] ?>" <?php endif ?>class="<?php echo isset( $disabled ) && 'yes' == $disabled ? 'disabled ' : '' ?>yit_options rm_option rm_input rm_select rm_bg-preview">
    <div class="option">
