...
<div id="<?php echo $id ?>-container" <?php if( isset( $is_default ) && $is_default ):?>data-is-default="true"<?php endif;?> <?php if( isset($deps) ): ?>data-field="<?php echo $id ?>" data-dep="<?php echo $deps['ids'] ?>" data-value="<?php echo $deps['values'] ?>" <?php endif ?>class="<?php echo isset( $disabled ) && 'yes' == $disabled ? 'disabled ' : '' ?>typography_container yit_options rm_typography rm_option rm_input rm_number rm_text">
    <div class="option">
