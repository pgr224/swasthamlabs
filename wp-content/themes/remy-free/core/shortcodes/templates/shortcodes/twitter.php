...
<?php
wp_enqueue_script( 'shortcode_twitter', YIT_Shortcodes()->shortcodes_assets_url . '/js/twitter-text.js', array( 'jquery' ), '', true );
wp_enqueue_script( 'yit_shortcode', YIT_Shortcodes()->shortcodes_assets_url . '/js/twitter.min.js', array( 'jquery', 'shortcode_twitter' ), '', true );
?>