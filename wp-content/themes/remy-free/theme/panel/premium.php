...
$premium_theme_name = 'remy';

$yithemes_landing = 'https://yithemes.com/themes/wordpress/remy';

$name = 'Rèmy : free food and restaurant theme';
...
<ul class="actions">
    <li class="buy-now">
        <a href="<?php echo $landing ?>">
            <p>Buy Now</p>
            <p>the premium version</p>
        </a>
    </li>
    <li class="live-preview">
        <a href="<?php echo $live ?>">
            <p>Live preview</p>
            <p>see the live preview</p>
        </a>
    </li>
</ul>
...
<ul class="premium-features">
    ...
    <!--
    <li>
        <img src="<?php echo $images_url ?>/pre-launch.png" alt="prelaunch icon" />

        <h3><?php _e('PRE-LAUNCH','yit');?></h3>

        <p>
            <?php _e('If your site is under maintenance, or in the pre-launch phase, with this plugin you can show to your users a fully customizable page that can include also a countdown.','yit');?>
        </p>
    </li>
    -->
    ...
    <!--
    <li>
        <img src="<?php echo $images_url ?>/grid-list.png" alt="grid list icon" />

        <h3><?php _e('ESSENTIAL GRID','yit');?></h3>

        <p>
            <?php _e('Essential grid allows you to show contents with a guiding grid, so that you can choose in detail their disposition in the page.','yit');?>
        </p>
    </li>

    <li>
        <img src="<?php echo $images_url ?>/portfolio.png" alt="portfolio icon" />

        <h3><?php _e('PORTFOLIO','yit');?></h3>
        <p>
            <?php _e('Show your projects with an elegant style and let the users flirt them following certain search parameters.','yit');?>
        </p>
    </li>

    <li>
        <img src="<?php echo $images_url ?>/tabs.png" alt="feature tab icon" />

        <h3><?php _e('FEATURES TAB','yit');?></h3>
        <p>
            <?php _e('The YIT Feature Tab plugin allows you to generate customized tab and add your contents swiftly and easily.','yit');?>
        </p>
    </li>
    -->
    ...
    <li>
        ...
        <h3><?php _e('2 SLIDER TYPES','yit');?></h3>

        <p>
            <?php _e('Compose your front page choosing your favourite slider to display your product and services betweeen "Revolution" and "Parallax".','yit');?>
        </p>
    </li>
