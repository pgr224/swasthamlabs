...
class YIT_Widget_Cart extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        if( !is_shop_installed() || ! function_exists('yit_get_current_cart_info') || $ywctm_hide_cart_page ) return;
        ?>
        <div class="yit_cart_widget widget_shopping_cart">
    		<div class="cart_label">
                ...
                <a href="<?php echo WC()->cart->get_cart_url(); ?>" class="cart-items" >
                    <div>
                        <span class="yit-mini-cart-background" style="background-image: url(<?php echo $cart_icon ?>)"></span>
	...
	function form( $instance ) {
		?>
        <p><?php _e('Display a dropdown cart for your WooCommerce store. This widget can be used only in Header Sidebar Right.', 'yit') ?></p>
		<?php
	}
