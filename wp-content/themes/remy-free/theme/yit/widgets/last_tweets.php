...
if ( ! class_exists( 'last_tweets' ) ) :
    ...
    class last_tweets extends WP_Widget {
        function __construct() {
            ...
            parent::__construct( 'last-tweets', __( 'Last Tweets', 'yit' ), $widget_ops, $control_ops );
        }
        ...
        function widget( $args, $instance ) {
            ...
            if ( ! isset( $twitter_data->errors ) ) :
                ...
                foreach ( $twitter_data as $tweet ) {
                    ...
                    echo '<li class="tweet_' . $i . '"><i class="fa fa-twitter widget-tweet-icon"></i><p><span class="text">' . $text . '</span><br />';
                    if ( $instance['time'] ) {
