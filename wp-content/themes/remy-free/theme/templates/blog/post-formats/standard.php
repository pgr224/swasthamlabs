...
?>
<div class="<?php echo $show_thumbnail ? 'thumbnail' : 'no-thumbnail' ?> <?php echo $show_thumbnail == 'thumbnail' && $blog_type == 'big' ? 'col-sm-9 col-sm-push-3' : ''?> <?php echo $blog_type ?>">
    <?php if( $show_thumbnail ) : ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
    <?php if( $blog_type == 'small' && $show_date && ! is_singular( 'post' ) ) : ?>
