...
//yit_enqueue_script( 'yit-testimonial', YIT_THEME_ASSETS_URL . '/js/yit-testimonial-frontend.js', array( 'jquery' ), null, true );
    ...
    while ( $tests->have_posts() ) : $tests->the_post();
        ...
        <div class="testimonial-col <?php echo $bootstrap_col_class ?>">
            <div class="testimonial-wrapper">
                <div class="clearfix <?php if ( $thumbnail == 'yes' && $has_post_thumbnail ) echo 'thumb'; ?>">
                ...
                <?php if( !empty( $website ) ) {
                    echo "<div class='text'>" . $website . "</div>";
                } ?>
