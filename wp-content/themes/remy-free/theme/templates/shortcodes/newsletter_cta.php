...
$icon_form = ( isset ( $icon_form ) ) ? $icon_form : '';
...
if( isset( $post_name ) && strcmp( $post_name, '' ) != 0 && $post_name != -1 ):
    ...
    if( isset($integration) && $integration != -1 && strcmp( $integration, '' ) != 0 ):
        ...
        $text_position = isset( $text_position ) ? $text_position : 'inline';
...
<div class="call-three">
    ...
    <div class="text <?php echo $text_position == 'inline' ? 'inline-cta' : '' ?>">
	...
	<div class="newsletter-call3 <?php echo $center ?> <?php echo $text_position == 'inline' ? 'inline-cta' : '' ?> clearfix">
        <?php
