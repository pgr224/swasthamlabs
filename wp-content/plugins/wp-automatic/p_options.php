						...
						<div style="min-height: 1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
							...
							<div class="postbox " >
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100 ">
										<label>Instagram session ID</label> <input value="<?php echo get_option( 'wp_automatic_it_sessionid' ) ?>" name="wp_automatic_it_sessionid" type="text">
										<div class="description">Check <a href="http://valvepress.com/how-to-get-cookie-value-from-a-browser/" target="_blank">this tutorial</a> on how to get your sessionid cookie </div>
									</div>
							...
							<div class="postbox " id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100 ">
										...
										<div class="description">Apply <a href="https://affiliates.walmart.com/linksharesignupnew" target="_blank">here</a> for recieving affiliate commisions.</div>
