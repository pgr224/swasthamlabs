...
?>
  ...
  <div class="mw-price-item">
    <label class="mw-price">
      ...
      <?php print $key; ?>
      <?php endif; ?>
      :</small> <?php print currency_format($v); ?> </label>
  </div>
  <?php endforeach ; ?>
  <?php } else{   ?>
  <?php  foreach($data  as $key => $v ): ?>
  ...
  <div class="mw-price-item"> <span class="mw-price"> <small>
    <?php if(is_string($key) and trim(strtolower($key)) == 'price'): ?>
    <?php _e($key); ?>
    <?php else: ?>
    <?php print $key; ?>
    <?php endif; ?>
    :</small> <?php print currency_format($v); ?> </span> </div>
  <?php endforeach ; ?>
  <?php } ?>
</div>
<?php endif; ?>
...
<?php else: ?>
<button class="btn-action add-to-cart" type="button" onclick="mw.cart.add('#<?php print $params['id'] ?>', LocalPrice, '<?php print $title; ?>');">
<?php _e("Add to cart"); ?>
</button>
<?php  endif; ?>
